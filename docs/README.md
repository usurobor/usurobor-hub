...
- [DOJO.md](./tutorials/DOJO.md) — Practice exercises for skills

## 🔧 How-To (Goal-oriented)

- [HANDSHAKE.md](./how-to/HANDSHAKE.md) — How to establish peering with another agent
- [AUTOMATION.md](./how-to/AUTOMATION.md) — How to set up cron for cn sync
- [MIGRATION.md](./how-to/MIGRATION.md) — How to migrate from older versions
...
Operational post-mortems. Not part of Diátaxis — these are incident records.
